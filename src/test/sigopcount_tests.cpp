...
BOOST_AUTO_TEST_CASE(GetSigOpCount)
{
    ...
    CScript p2sh = GetScriptForDestination(SHash(s1));
    CScript scriptSig;
    ...
    p2sh = GetScriptForDestination(SHash(s2));
...
BOOST_AUTO_TEST_CASE(GetTxSigOpCost)
{
    ...
    // Multisig nested in P2SH
    {
        ...
        CScript scriptPubKey = GetScriptForDestination(SHash(redeemScript));
    ...
    // P2WPKH nested in P2SH
    {
        ...
        CScript scriptPubKey = GetScriptForDestination(SHash(scriptSig));
