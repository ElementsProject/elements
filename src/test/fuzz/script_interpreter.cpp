    ...
    FuzzedDataProvider fuzzed_data_provider(buffer.data(), buffer.size());
    {
        ...
        if (mtx) {
            ...
            if (in < tx_to.vin.size()) {
                ...
                (void)SignatureHash(script_code, tx_to, in, n_hash_type, amount, sigversion, 0, nullptr);
                ...
                if (mtx_precomputed) {
                    ...
                    (void)SignatureHash(script_code, tx_to, in, n_hash_type, amount, sigversion, 0, &precomputed_transaction_data);
                }
            }
        }
    }
