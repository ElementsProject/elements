...
std::vector<unsigned char> pegin_transaction_eth = ParseHex("");
...
BOOST_AUTO_TEST_CASE(eth_pegin_valid)
{
    ...
    BOOST_CHECK(IsValidEthPegin(test_valid, amount, strFailReason));
    ...
    BOOST_CHECK(!IsValidEthPegin(test_invalid1, amount, strFailReason));
    ...
    BOOST_CHECK(!IsValidEthPegin(test_invalid2, amount, strFailReason));
    ...
    BOOST_CHECK(!IsValidEthPegin(test_invalid3, amount, strFailReason));
    ...
    BOOST_CHECK(!IsValidEthPegin(test_invalid4, 1, strFailReason));
    ...
    BOOST_CHECK(!IsValidEthPegin(test_invalid5, amount, strFailReason));
