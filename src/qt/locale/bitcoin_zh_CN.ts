...
<context>
    ...
    <message>
        <source>Native segwit addresses (aka Blech32) reduce your transaction fees later on and offer better protection against typos, but old wallets don't support them. When unchecked, an address compatible with older wallets will be created instead.</source>
        <translation>原生隔离见证地址（又称为Blech32）可减少您日后的交易费用，并且可以更好的防范打字错误，但旧版本的钱包不能识别这种地址。如果取消勾选，则会生成一个与旧版本钱包兼容的地址。</translation>
    </message>
    <message>
        <source>Generate native segwit (Blech32) address</source>
        <translation>生成原生隔离见证 (Blech32)地址</translation>
    </message>
    <message>
