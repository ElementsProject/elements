...
QString AddressTableModel::addRow(const QString &type, const QString &label, const QString &address, const OutputType address_type)
{
    ...
    else if(type == Receive)
    {
        ...
        if (auto dest{walletModel->wallet().getNewDestination(address_type, strLabel, true)}) {
            ...
            if (auto dest_retry{walletModel->wallet().getNewDestination(address_type, strLabel, true)}) {
