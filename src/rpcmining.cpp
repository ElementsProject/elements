...
Value getblocktemplate(const Array& params, bool fHelp)
{
    ...
    result.push_back(Pair("sigoplimit", (int64_t)MaxBlockSigops(cGlobalChainParams.Get().GetConsensus())));
    result.push_back(Pair("sizelimit", (int64_t)MaxBlockSize(cGlobalChainParams.Get().GetConsensus())));
