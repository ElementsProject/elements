...
public:
    ...
    // ELEMENTS:
    static void SetPegin(CoinsCachePair& pair, CoinsCachePair& sentinel) noexcept { AddFlags(PEGIN, pair, sentinel); }
    ...
    // ELEMENTS:
    bool IsPegin() const noexcept { return m_flags & PEGIN; }
