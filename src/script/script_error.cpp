...
std::string ScriptErrorString(const ScriptError serror)
{
    switch (serror)
    {
        ...
        case SCRIPT_ERR_SIMPLICITY_BITSTREAM_UNUSED_BYTES:
            return SIMPLICITY_ERR_MSG(SIMPLICITY_ERR_BITSTREAM_UNUSED_BYTES);
        case SCRIPT_ERR_SIMPLICITY_BITSTREAM_UNUSED_BITS:
            return SIMPLICITY_ERR_MSG(SIMPLICITY_ERR_BITSTREAM_UNUSED_BITS);
        ...
        case SCRIPT_ERR_SIMPLICITY_WITNESS_UNUSED_BITS:
            return SIMPLICITY_ERR_MSG(SIMPLICITY_ERR_WITNESS_UNUSED_BITS);
