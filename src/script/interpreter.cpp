...
bool GenericTransactionSignatureChecker<T>::CheckSimplicity(const valtype& witness, const std::vector<unsigned char>& program, const rawTapEnv& simplicityRawTap, int64_t budget, ScriptError* serror) const
{
    ...
    case SIMPLICITY_ERR_BITSTREAM_UNUSED_BYTES: return set_error(serror, SCRIPT_ERR_SIMPLICITY_BITSTREAM_UNUSED_BYTES);
    case SIMPLICITY_ERR_BITSTREAM_UNUSED_BITS: return set_error(serror, SCRIPT_ERR_SIMPLICITY_BITSTREAM_UNUSED_BITS);
    ...
    case SIMPLICITY_ERR_WITNESS_UNUSED_BITS: return set_error(serror, SCRIPT_ERR_SIMPLICITY_WITNESS_UNUSED_BITS);
