...
/**
 * Default setting for nMaxDatacarrierBytes. 100000 bytes
 * (MAX_STANDARD_TX_WEIGHT / WITNESS_SCALE_FACTOR = 400000 / 4).
 */
static const unsigned int MAX_OP_RETURN_RELAY = 100000;
