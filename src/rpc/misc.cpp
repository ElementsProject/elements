...
static RPCHelpMan calcfastmerkleroot()
{
    return RPCHelpMan{"calcfastmerkleroot",
        "\nComputes the fast (midstate-based) merkle root of an array of data.\n",
        {
            {"leaves", RPCArg::Type::ARR, RPCArg::Optional::NO, "The hex-encoded data.",
                {
                    {"data", RPCArg::Type::STR_HEX, RPCArg::Optional::OMITTED, ""},
            }},
        },
        RPCResult{
            RPCResult::Type::STR_HEX, "root", "Hex-encoded merkle root of the data."
        },
        RPCExamples{""},
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
