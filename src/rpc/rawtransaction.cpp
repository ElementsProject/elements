...
UniValue createkycpubkeytx(const JSONRPCRequest& request){
if (request.fHelp || request.params.size() != 1) 
    throw runtime_error(
            "createkycpubkeytx \"nkeys\" \n"
            ...
            "\nExamples:\n"
            + HelpExampleCli("createkycpubkeytx", "\"nkeys\"")
            + HelpExampleRpc("createkycpubkeytx", "\"nkeys\"")
            );
...
{ //  category              name                      actor (function)         okSafeMode
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    { "rawtransactions",    "createkycpubkeytx",      &createkycpubkeytx,      true,  {"nkeys"} },
