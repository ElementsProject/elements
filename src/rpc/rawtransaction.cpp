...
UniValue createrawpolicytx(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 4)
        throw runtime_error(
            ...
            "      \"userkey1\": \"userkey\"      (string, optional) The key is \"userkey1\", the value is hex encoded 32 byte key to be added to the policy list\n"
            ...
            "      \"userkey2\": \"userkey\"      (string, optional) The key is \"userkey2\", the value is hex encoded 32 byte key to be added to the policy list\n"
            "    }\n"
            "       ,...\n"
            "     ]\n"
