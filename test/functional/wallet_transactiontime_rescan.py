    ...
    def run_test(self):
        ...
        if not self.options.descriptors:
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as thread:
                with minernode.assert_debug_log(expected_msgs=["Rescan started from block cd179c84c35f51825f20a3b91a18d45f0c53b5ceb744a5b6ef8f0babe809396f... (slow variant inspecting all blocks)"], timeout=5):
