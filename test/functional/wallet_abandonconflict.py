...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        sync_blocks(self.nodes)
        newbalance = self.nodes[0].getbalance()[BITCOIN_ASSET]
        ...
        unconfbalance = self.nodes[0].getunconfirmedbalance() + self.nodes[0].getbalance()[BITCOIN_ASSET]
        ...
        assert_equal(len(self.nodes[0].getrawmempool()), 0)
        assert_equal(self.nodes[0].getbalance()[BITCOIN_ASSET], balance)
