...
class PSBTTest(BitcoinTestFramework):
    ...
    def pset_confidential_proofs(self):
        ...
        # PSETs can have input and output asset blinding factors
        decoded = self.nodes[0].decodepsbt(INPUT_OUTPUT_ABF)
        assert decoded["inputs"][0]["asset_blinder"] == "3311111111111111111111111111111111111111111111111111111111111111"
        assert decoded["outputs"][0]["asset_blinder"] == "3311111111111111111111111111111111111111111111111111111111111111"
