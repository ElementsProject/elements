...
class WalletGroupTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # - C1 0.5      - F  ~1.3
        # - D ~0.3
        assert_approx(self.nodes[1].getbalance()['bitcoin'], 4.3, 0.0001)
        assert_approx(self.nodes[2].getbalance()['bitcoin'], 4.3, 0.0001)
        ...
        values.sort()
        assert_approx(values[0], 0.00001, 0.0001) # ELEMENTS: fee
        assert_approx(values[1], 0.1, 0.0001)
        assert_approx(values[2], 1.4)
