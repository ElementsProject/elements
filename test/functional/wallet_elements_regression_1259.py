...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Send some policy asset to node 1")
        self.nodes[0].sendtoaddress(self.nodes[1].getnewaddress(), 10)
        self.generate(self.nodes[0], 1)

        self.log.info("Issuing an asset from node 0")
        ...
        self.log.info("Send the raw transaction")
