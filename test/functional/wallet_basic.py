...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[2].generate(1)
        self.sync_all(self.nodes[0:3])
        node_2_bal = self.check_fee_amount(self.nodes[2].getbalance()['bitcoin'], node_2_bal - Decimal('10'), explicit_fee_per_byte, self.get_vsize(self.nodes[2].gettransaction(txid)['hex']))
        assert_equal(self.nodes[2].getbalance()['bitcoin'], node_2_bal)
        node_0_bal += Decimal('10')
        assert_equal(self.nodes[0].getbalance()['bitcoin'], node_0_bal)
