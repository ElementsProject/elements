...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        with self.nodes[0].assert_debug_log(expected_msgs=[f'Rescan started from block cd179c84c35f51825f20a3b91a18d45f0c53b5ceb744a5b6ef8f0babe809396f... (slow variant inspecting all blocks)'], timeout=5):
            t.start()
