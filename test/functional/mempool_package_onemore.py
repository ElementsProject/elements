...
class MempoolPackagesTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        fee = Decimal("0.0003")  ## ELEMENTS bumped fee to hit minrelayfee requirement
        ...
        second_tx_outputs = {self.nodes[0].getrawtransaction(replacable_txid, True)["vout"][0]['scriptPubKey']['address']: replacable_orig_value - (Decimal(1) / Decimal(100)),"fee": fee + Decimal(1) / Decimal(100)}
