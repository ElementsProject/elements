...
from .messages import CTransaction, CTxOut, sha256, hash256, uint256_from_str, ser_uint256, ser_string, ser_vector, ser_compact_size
...
def SignatureHash(script, txTo, inIdx, hashtype):
    ...
    if hashtype & SIGHASH_RANGEPROOF:
