...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_feerate_with_conf_target_and_estimate_mode(self):
        ...
        # ELEMENTS: reduce feerate by a factor of 10 to avoid maxtxfee
        for unit, fee_rate in {"btc/kb": 0.01, "sat/b": 1000}.items():
            ...
            # Expect fee to be 1,000x higher when explicit fee 1,000x greater is specified.
            result = node.fundrawtransaction(rawtx, {"conf_target": fee_rate, "estimate_mode": unit})
            assert_approx(result["fee"], vexp=0.02491, vspan=0.00001)
